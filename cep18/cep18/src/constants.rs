...
pub const TREASURY_ADDRESS: &str = "treasury_address";
pub const TEAM_ADDRESS: &str = "team_address";
pub const STAKING_ADDRESS: &str = "staking_address";
pub const INVESTOR_ADDRESS: &str = "investor_address";
